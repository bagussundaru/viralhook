...
export default function DaftarPage() {
  ...
  const onSubmit = async (data: DaftarForm) => {
    setError(null);
    ...
    if (result.error) {
      if (
        ...
        result.error.message?.includes("taken")
      ) {
  ...
  return (
    <Card className="border-0 shadow-none">
      <CardHeader className="px-0">
        <CardTitle className="text-2xl">Daftar Gratis</CardTitle>
        <CardDescription>Mulai bikin konten viral sekarang — gratis! 🚀</CardDescription>
      </CardHeader>
